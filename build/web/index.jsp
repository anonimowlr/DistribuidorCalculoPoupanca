...
<%
    ...
    if (session.getAttribute("usuarioLogado") == null) {
        if (request.getParameter("ibm-nativeid") == null) {
            ...
            session.setAttribute("usuarioLogado", new FuncionarioDAO().getFuncionario(request.getParameter("ibm-nativeid"),request.getParameter("cd-eqp"),request.getParameter("nm-idgl"),request.getParameter("nm-idgl"),request.getParameter("tx-cmss-usu")));
